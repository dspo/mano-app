...
export const COMMENTS_PANEL_COMMAND: LexicalCommand<boolean> = createCommand(
  'COMMENTS_PANEL_COMMAND',
);
...
export default function CommentPlugin({
  ...
  // Handle comments panel command from ActionsPlugin
  useEffect(() => {
    return editor.registerCommand(
      COMMENTS_PANEL_COMMAND,
      (payload) => {
        setShowComments(payload);
        return true;
      },
      COMMAND_PRIORITY_HIGH,
    );
