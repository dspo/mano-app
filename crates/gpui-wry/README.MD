...
`gpui-wry` integrates GPUI with GPUI Component and WRY (a cross-platform WebView library)
...
- **WebView Integration**: Thanks to the GPUI Component project, we can leverage Wry to integrate WebView components into GPUI Apps
...
- [GPUI Component](https://longbridge.github.io/gpui-component/) offers many useful and refined components, especially the WebView component, allowing us to integrate WebViews into GPUI Apps using Wry.
